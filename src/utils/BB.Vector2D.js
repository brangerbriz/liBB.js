 ...
 * @param {Number} x Represents the x value of the vector
 * @param {Number} y Represents the y value of the vector
 * @return {BB.Vector2D} this vector.
 */
 ...
 * @method add
 * @chainable
 * @param {BB.Vector2D} v The vector to add to this vector
 * @return {BB.Vector2D} this vector.
 */
 ...
 * @method addVectors
 * @chainable
 * @param {BB.Vector2D} a The first vector.
 * @param {BB.Vector2D} b The second vector.
 * @return {BB.Vector2D} This vector.
 */
 ...
 * @method sub
 * @chainable
 * @param {BB.Vector2D} v The vector to subtract from this vector
 * @return {BB.Vector2D} this vector.
 */
 ...
 * @method min
 * @chainable
 * @param  {BB.Vector2D} v The vector to check and assign min values from
 * @return {BB.Vector2D}   This vector.
 */
 ...
 * @method max
 * @chainable
 * @param  {BB.Vector2D} v The vector to check and assign max values from
 * @return {BB.Vector2D}   This vector.
 */
 ...
 * @method clamp
 * @chainable
 * @param  {BB.Vector2D} min The vector containing the min x and y values in the desired range.
 * @param  {BB.Vector2D} max The vector containing the max x and y values in the desired range.
 * @return {BB.Vector2D}     This vector.
 */
 ...
 * @method lerp
 * @chainable
 * @param  {BB.Vector2D} v  The vector to lerp this vector with.
 ...
 * @method lerpVectors
 * @chainable
 * @param  {BB.Vector2D} v1  The first vector.
 * @param  {BB.Vector2D} v2  The second vector.
 * @param  {Number} alpha Percentage along the line (0 - 1).
 * @return {BB.Vector2D}  This vector.
 */
 ...
 * @method equals
 * @param  {BB.Vector2D} v The vector to check equality against.
 * @return {Boolean}
 */
 ...
 * Clones this vector.
 * @method clone
 * @return {BB.Vector2D} A new vector with this vectors x and y values.
 */
...
if( typeof module !== "undefined") module.exports = Vector2D;
